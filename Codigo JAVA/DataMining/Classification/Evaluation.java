...
import DataMining.Classification.evaluation.AbstractEvaluationMetric;
...
public class Evaluation implements Serializable, Summarizable, RevisionHandler {
  ...
  public DataMining.Classification.evaluation.Evaluation m_delegate;
  ...
  public Evaluation(Instances data) throws Exception {
    m_delegate = new DataMining.Classification.evaluation.Evaluation(data);
  }

  public Evaluation(Instances data, CostMatrix costMatrix) throws Exception {
    m_delegate = new DataMining.Classification.evaluation.Evaluation(data, costMatrix);
  }
   ...
   *          weka.classifiers.evaluation.output.prediction.AbstractOutput
   *          object
     * @return todos los valores de clasificación para cada fold
   * @throws Exception if a classifier could not be generated successfully or
   *           the class is not defined
   */
  public void crossValidateModel2(Classifier classifier, Instances data,
    int numFolds, Random random, Object... forPredictionsPrinting)
    throws Exception {
    m_delegate.crossValidateModel2(classifier, data, numFolds, random,
      forPredictionsPrinting);
  }
  
  public double[] getErrorRatesByFolds(){
      return m_delegate.ErrorRatesByfolds;
  }
  public double[] getFMeasureByfolds(){
       return m_delegate.FMeasureByfolds;
  }
  public double[] getMCCByfolds(){
      return m_delegate.MCCByfolds;
  }
  public double[] getPRCByfolds(){
      return m_delegate.PRCByfolds;
  }
  public double[] getPrecisionByfolds(){
      return m_delegate.PrecisionByfolds;
  }
  public double[] getROCByfolds(){
      return m_delegate.ROCByfolds;
  }
  public double[] getRecallByfolds(){
      return m_delegate.RecallByfolds;
  }
  
  public void setStatistics(int i){
      this.m_delegate.setStatistics(i);
  }
  /**
   * Performs a (stratified if class is nominal) cross-validation for a
   ...
   * @throws Exception if model could not be evaluated successfully
   */
  public void evaluateModel(Classifier classifier, Instances data,
    Object... forPredictionsPrinting) throws Exception {
    m_delegate.evaluateModel(classifier, data, forPredictionsPrinting);
  }
  ...
  */
  public int getM_NumClasses() {
    return m_delegate.getM_NumClasses();
  }
  ...
  */
  public String[] getM_ClassNames() {
    return m_delegate.getM_ClassNames();
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof DataMining.Classification.Evaluation) {
      obj = ((DataMining.Classification.Evaluation) obj).m_delegate;
    }
